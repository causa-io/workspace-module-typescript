...
describe('renderControllerFile', () => {
  it('should render a controller file', () => {
    ...
    expect(result).toMatch(/_NestjsCommonGet\(':id'\)\([^)]+, 'get'/);
    expect(result).toMatch(
      /_NestjsCommonHttpCode\(_NestjsCommonHttpStatus\.OK\)\([^)]+, 'get'/,
    );
    expect(result).toMatch(
    ...
    expect(result).toMatch(/_NestjsCommonGet\(''\)\([^)]+, 'list'/);
    expect(result).toMatch(
      /_NestjsCommonHttpCode\(_NestjsCommonHttpStatus\.OK\)\([^)]+, 'list'/,
    );
    expect(result).toMatch(
    ...
    expect(result).toMatch(/_NestjsCommonPost\(''\)\([^)]+, 'create'/);
    expect(result).toMatch(
      /_NestjsCommonHttpCode\(_NestjsCommonHttpStatus\.CREATED\)\([^)]+, 'create'/,
    );
    expect(result).toMatch(
      /_NestjsCommonBody\(\)\(constructor\.prototype, 'create', 0\)/,
    );
    ...
    expect(result).toMatch(/_NestjsCommonDelete\(':id'\)\([^)]+, 'delete'/);
    expect(result).toMatch(
      /_NestjsCommonHttpCode\(_NestjsCommonHttpStatus\.NO_CONTENT\)\([^)]+, 'delete'/,
    );
    expect(result).toMatch(
      /_NestjsCommonParam\(\)\(constructor\.prototype, 'delete', 0\)/,
    );
    ...
    expect(result).toMatch(/_NestjsCommonPatch\(':id'\)\([^)]+, 'update'/);
    expect(result).toMatch(
      /_NestjsCommonHttpCode\(_NestjsCommonHttpStatus\.OK\)\([^)]+, 'update'/,
    );
    expect(result).toMatch(
      /_NestjsCommonParam\(\)\(constructor\.prototype, 'update', 0\)/,
    );
    expect(result).toMatch(
      /_NestjsCommonQuery\(\)\(constructor\.prototype, 'update', 1\)/,
    );
    expect(result).toMatch(
    ...
    // Imports
    expect(result).toMatch(
      /import \{[^}]*Controller as _NestjsCommonController[^}]*\}/,
    );
    ...
    expect(result).toMatch(/_NestjsCommonController\('cars'\)/);
  });
});
